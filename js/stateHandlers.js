...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            this.attributes['playOrder'] = Array.apply(null, {length: AudioManager.audioAssets().length}).map(Number.call, Number);
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                ...
                message = 'You were listening to ' + AudioManager.audioAssets()[this.attributes['playOrder'][this.attributes['index']]].title +
    ...
    resumeDecisionModeIntentHandlers : Alexa.CreateStateHandler(constants.states.RESUME_DECISION_MODE, {
         ...
         */
        'LaunchRequest' : function () {
            var message = 'You were listening to ' + AudioManager.audioAssets()[this.attributes['playOrder'][this.attributes['index']]].title +
                ' Would you like to resume?';
        ...
        'AMAZON.HelpIntent' : function () {
            var message = 'You were listening to ' + AudioManager.audioAssets()[this.attributes['index']].title +
                ' Would you like to resume?';
            var reprompt = 'You can say yes to resume or no to play from the top.';
            this.response.speak(message).listen(reprompt);
            this.emit(':responseReady');
...
var controller = function () {
    return {
        play: function () {
            ...
            var podcast = AudioManager.audioAssets()[this.attributes['playOrder'][this.attributes['index']]];
        ...
        playNext: function () {
            ...
            if (index === AudioManager.audioAssets().length) {
        ...
        playPrevious: function () {
            ...
            if (index === -1) {
                if (this.attributes['loop']) {
                    index = AudioManager.audioAssets().length - 1;
                } else {
                    // Reached at the end. Thus reset state to start mode and stop playing.
                    this.handler.state = constants.states.START_MODE;
