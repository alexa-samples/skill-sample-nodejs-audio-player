...
describe('Multiple Stream Audio Player Test : LaunchRequest with no Audio Player interface', function () {

  // pre-requisites
  before(() => {
    return new Promise((resolve, reject) => {
      const event = require('./requests/launch_request_no_audio_player.json')
